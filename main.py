...
def main():
    ...
    depth_visualizer = DepthVisualizer()  # Add depth visualization
    ...
    while cap.isOpened():
        ...
        depth_frame = depth_visualizer.visualize_depth(frame)  # Generate depth visualization
        
        cv2.imshow("Waste Disposal Monitoring", vis_frame)
        cv2.imshow("Depth Visualization", depth_frame)  # Show depth separately
    ...
    report_path = reporter.export_events(event_detector.events_data)
